...
def load_net(cfg_file= 'models/cfg/yolov3-tiny-foot-top.cfg', weights_file= 'models/weights/yolov3-tiny-foot-top_final.weights'):
...
if __name__ == '__main__':
    ...
    image_directory = './feet_data-top/valid'                        # Input image
    ...
    for image_name in os.listdir(image_directory):
        ...
        if image_name.endswith('.jpg'):
            ...
            cv2.imwrite(f"./results-top/{image_name}", image)