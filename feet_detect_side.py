...
def load_net(cfg_file= 'models/cfg/yolov3-tiny-feet-side.cfg', weights_file= 'models/weights/yolov3-tiny-feet-side_final.weights'):
...
if __name__ == '__main__':
    ...
    image_directory = './feet_data-side/valid'                        # Input image
    ...
    for image_name in os.listdir(image_directory):
        ...
        if image_name.endswith('.jpg'):
            ...
            cv2.imwrite(f"./results-side/{image_name}", image)